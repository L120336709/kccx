...
function appendData(result) {
    ...
    if (result.rows != null && result.rows.length > 0) {
        ...
        $.each(result.rows, function (idx, t) {
            ...
            html += '<tr ><td style="width: 40px">'+abb+'</td>'
            html += '<td style="width: 60px">' +result.rows[idx].studentName+'</td>'
            html += '<td style="width: 40px"> ' +result.rows[idx].jobnumber+'</td>'
            html += '<td  style="width: 140px">' +result.rows[idx].schoolcode+'</td>'
            html += '<td style="width: 40px">' +result.rows[idx].gradeCode+'</td>'
            html += '<td style="width: 40px">' +result.rows[idx].classCode+'</td></tr>'
