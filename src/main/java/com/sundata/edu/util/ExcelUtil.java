...
import com.sundata.edu.annotation.Excels;
import com.sundata.edu.config.WangConfig;
import com.sundata.edu.framework.web.result.AjaxResult;
import com.sundata.edu.util.file.FileTypeUtils;
import com.sundata.edu.util.file.FileUtils;
import com.sundata.edu.util.file.ImageUtils;
import com.sundata.edu.util.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = WangConfig.getDownloadPath() + filename;
