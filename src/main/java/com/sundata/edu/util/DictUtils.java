    ...
    public static String getDictLabel(String dictType, String dictValue, String separator)
    {
        ...
        if (StringUtils.containsAny(separator, dictValue) && StringUtils.isNotEmpty(datas))
        {
            for (SysDictData dict : datas)
            {
                ...
                {
                    if (value.equals(dict.getDataValue()))
                    {
                        propertyString.append(dict.getDataLabel() + separator);
                        break;
                    }
                }
            }
        ...
        else
        {
            for (SysDictData dict : datas)
            {
                if (dictValue.equals(dict.getDataValue()))
                {
    ...
    public static String getDictValue(String dictType, String dictLabel, String separator)
    {
        ...
        if (StringUtils.containsAny(separator, dictLabel) && StringUtils.isNotEmpty(datas))
        {
            for (SysDictData dict : datas)
            {
                ...
                {
                    if (label.equals(dict.getDataLabel()))
                    {
                        propertyString.append(dict.getDataValue() + separator);
                        break;
                    }
                }
            }
        ...
        else
        {
            for (SysDictData dict : datas)
            {
                if (dictLabel.equals(dict.getDataLabel()))
                {
